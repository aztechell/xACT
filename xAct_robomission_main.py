...
def mission(robot):
    return [
        SequentialAction(robot, [
            ...
            robot.drive_to_point_action(_X = 600, _Y = 0, speed = 100),
            robot.drive_to_point_action(_X = 600, _Y = 600, speed = 100),
            robot.drive_to_point_action(_X = 0, _Y = 600, speed = 100),
            robot.drive_to_point_action(_X = 0, _Y = 0, speed = 100),
            robot.turn_to_heading_action(0),
            robot.drive_to_point_action(_X = 600 - 80, _Y = 0, speed = 100),
            robot.one_wheel_turn_action("L", 90, 1000),
            robot.drive_to_point_action(_X = None, _Y = 600 - 160, speed = 100),
            robot.one_wheel_turn_action("L", 90, 1000),
            robot.drive_to_point_action(_X = 0 + 80, _Y = None, speed = 100),
            robot.one_wheel_turn_action("L", 90, 1000),
            robot.drive_to_point_action(_X = 0, _Y = 0, speed = 100),
            robot.turn_to_heading_action(0),
        ])
